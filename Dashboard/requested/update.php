...
$sql = "select * from `requested` WHERE id = '$id';";
...
if (isset($_POST['name'])) {
    ...
    $sql_up = "UPDATE `requested` SET `name`='$name',`phone`='$phone',`address`='$address',`part`='$part' WHERE id=$id";
...
<head>
    ...
    <title>OD Admin | Update Requested Organs Data </title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Update Requested Organs Information</h1>
                                </div>
