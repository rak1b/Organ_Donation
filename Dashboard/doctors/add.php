...
if (isset($_POST['name'])) {
    ...
    $sql = "INSERT INTO `doctors`(`name`, `degree`, `experienced_in`, `email`, `phone`, `address`) VALUES ('$name','$degree','$experienced_in','$email','$phone','$address')";

    echo $sql;

    $res=mysqli_query($con,$sql); 
    if($res){
        echo "<script> alert('New doctor added successfull'); </script>";
...
<head>
    ...
    <title>OD Admin | New Doctor </title>
                            ...
                            <div class="p-5">
                                ...
                                <form action="add.php" method="post">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col mt-4">
                                            <input type="text" name='experienced_in'  class="form-control" placeholder="Experienced In">
                                        </div>
                                    </div>
