...
if (isset($_POST['name'])) {
    ...
    $name = $_POST['name'];
    $degree = $_POST['degree'];
    $experienced_in = $_POST['experienced_in'];
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $address = $_POST['address'];

    $sql_up = "UPDATE `doctors` SET `name`='$name',`degree`='$degree',`experienced_in`='$experienced_in',`email`='$email',`phone`='$phone',`address`='$address' WHERE id=$id";
...
<head>
    ...
    <title>OD Admin | Update Doctors Data </title>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Update Doctors Information</h1>
                                </div>
                                <form action="update.php?id=<?php echo $id ?>" method="post">
                                    ...
                                    <div class="row align-items-center mt-4">
                                        <div class="col">
                                            <input type="text" name='degree' value="<?php echo $row['degree']?>" class="form-control" placeholder="Degree">
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col mt-4">
                                            <input type="text" name='experienced_in' value="<?php echo $row['experienced_in']?>" class="form-control" placeholder="Experienced In">
                                        </div>
                                    </div>
